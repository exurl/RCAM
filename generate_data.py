...
# Dummy index to limit iterations for testing
dummy_idx = 0
...
for trim_case, trim_data in trim_results.items():
    ...
    for profile_ID, profile_data in control_profiles.items():
        ...
        # if dummy_idx == 4 or dummy_idx == 8 or dummy_idx == 12 or dummy_idx == 16 or dummy_idx == 20 or dummy_idx == 24:
        if dummy_idx == 28 or dummy_idx == 32:
...
# np.savez("RCAM_data.npz", **RCAM_data)
...
# # Example access
# time = results['trim1']['step_input']['time']
# states = results['trim1']['step_input']['states']
